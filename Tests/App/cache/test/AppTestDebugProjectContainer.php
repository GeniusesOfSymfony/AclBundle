...
class AppTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer(new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($this->get('kernel'), $this->get('templating.filename_parser'), (dirname(dirname(__DIR__)).'/Resources')), $this->get('templating.locator')), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router'))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'test_acl', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        return $this->services['problematic.acl_manager'] = new \Problematic\AclManagerBundle\Domain\AclManager($this->get('security.acl.provider'), $this->get('security.context'), new \Problematic\AclManagerBundle\RetrievalStrategy\AclObjectRetrievalStrategy(), $this->get('doctrine.dbal.default_connection'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($d, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), NULL), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => new \Symfony\Component\Security\Core\User\InMemoryUserProvider()), 'main', NULL, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '54962828aa880', NULL, $b), 3 => new \Symfony\Component\Security\Http\Firewall\AccessListener($a, $this->get('security.access.decision_manager'), $d, $b)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\HttpUtils($c, $c), 'main', NULL, NULL, NULL, NULL));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fr.xlf'), 'fr', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sv.xlf'), 'sv', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.cs.xlf'), 'cs', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ar.xlf'), 'ar', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sl.xlf'), 'sl', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_BR.xlf'), 'pt_BR', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hu.xlf'), 'hu', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ca.xlf'), 'ca', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.el.xlf'), 'el', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Latn.xlf'), 'sr_Latn', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.en.xlf'), 'en', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ru.xlf'), 'ru', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.da.xlf'), 'da', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Cyrl.xlf'), 'sr_Cyrl', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.no.xlf'), 'no', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ro.xlf'), 'ro', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.de.xlf'), 'de', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ua.xlf'), 'ua', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pl.xlf'), 'pl', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.es.xlf'), 'es', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lb.xlf'), 'lb', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fa.xlf'), 'fa', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.he.xlf'), 'he', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.it.xlf'), 'it', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.az.xlf'), 'az', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_PT.xlf'), 'pt_PT', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.gl.xlf'), 'gl', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.nl.xlf'), 'nl', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.tr.xlf'), 'tr', 'security');
        $instance->addResource('xlf', (dirname(dirname(dirname(dirname(__DIR__)))).'/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sk.xlf'), 'sk', 'security');
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        return $this->services['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(array(0 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter($b), 1 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($a), 2 => new \Symfony\Component\Security\Acl\Voter\AclVoter($this->get('security.acl.provider'), new \Symfony\Component\Security\Acl\Domain\ObjectIdentityRetrievalStrategy(), new \Symfony\Component\Security\Acl\Domain\SecurityIdentityRetrievalStrategy($b, $a), new \Symfony\Component\Security\Acl\Permission\BasicPermissionMap(), NULL, true)), 'affirmative', false, true);
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54962828aa880')), true);
